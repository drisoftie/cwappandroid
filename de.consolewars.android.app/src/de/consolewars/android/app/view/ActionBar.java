...
public class ActionBar extends RelativeLayout implements OnClickListener {
	 ...
	 * 
	 * This is ment to be used instead of the setHomeAction and does not draw a divider to the left of the provided
	 * logo.
	 * 
	 * @param resId
	...
	/*
	 * Emulating Honeycomb, setdisplayHomeAsUpEnabled takes a boolean and toggles whether the "home" view should have a
	 * little triangle indicating "up"
	 */
