...
public class Message implements IUnixtime {
	...
	public Message(String title, int id, int tid, String mode,
			String fromusername, int fromuserid, String tousername,
			int touserid, String message, String origmessage, int unixtime,
			boolean messageread) {
		super();
		this.title = title;
		this.id = id;
